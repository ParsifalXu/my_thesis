...
We design an ablation study to quantify how two mechanisms detailed in~\cref{sec:method:val-dataloc} and \cref{sec:method:int-dataloc} improve the quality of LLM-generated Datalog program.
