...
An ablation study quantifies how two mechanisms detailed in \sref{sec:method:val-dataloc} and \sref{sec:method:int-dataloc} improve the quality of LLM-generated Datalog program.
...
The study evaluates three configurations that progressively enable these mechanisms:
...
\textbf{Metrics}
The study compares (i) execution success rate and non-empty result rate, (ii) mean LLM iterations to first successful execution and (iii) final answer correctness. This evaluation is conducted on a representative subset of \dataset, consisting of the first 25 queries.
