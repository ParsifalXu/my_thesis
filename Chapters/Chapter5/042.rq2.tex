...
To evaluate the practical utility of \tooldataloc in real-world software maintenance, a comparative analysis was conducted on SWE-bench Lite. Existing approaches usually employ top-$n$ strategy, whereas \tooldataloc operates without a predefined $n$. \tref{tab:comparison_isq} illustrates that \tooldataloc remains highly competitive.
