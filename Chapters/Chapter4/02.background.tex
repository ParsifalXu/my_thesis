...
In this section, we review the essential terminology and background necessary for understanding the
remainder of the paper.

\subsection{Multi-Parameter Constraints}\label{sec:eg}
...
\subsubsection{Example 1: Explicit Constraint}\label{sec:eg1}
...
\subsubsection{Example 2: Implicit Constraint}\label{sec:eg2}
...
\textit{x} is ignored (see \cref{sec:fuzzword}).
