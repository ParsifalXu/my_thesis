...
\subsection{Threats to Validity}\label{sec:valid}

\paragraph{Internal}
There is no established ground truth for multi-parameter code-documentation inconsistencies. To
mitigate this, we manually reviewed and verified inconsistencies detected by \tool. Given the
