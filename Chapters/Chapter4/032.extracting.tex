...
We also input the parameter list obtained in Section~\ref{sec:preprocess-mpchecker} into GPT-4 to help model better recognize the information related to parameters. The details of the document input prompt are shown in Prompt 1 in Figure~\ref{fig:prompt}.
