...
In this chapter, we propose \toolchecker, a multi-parameter constraint checker for Python data science libraries. \toolchecker utilizes both LLMs and symbolic execution to detect inconsistencies between code and documentation. 
