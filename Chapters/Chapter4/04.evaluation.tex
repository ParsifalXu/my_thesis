...
To measure \toolchecker's effectiveness in detecting multi-parameter API documentation errors, we evaluated our tool on the inconsistency dataset. Table~\ref{tab:res} shows the results of \toolchecker in detecting multi-parameter CDI on the inconsistency dataset.
