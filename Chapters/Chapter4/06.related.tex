...
A line of research~\cite{wadhwa2024codequality,jin2023programrepair,yang2024programrepair,xia2024programrepair,nam2024codeunderstand,zhang2024codeinconsistency} focuses on using LLMs for program analysis. Wadhwa et al.~\cite{wadhwa2024codequality} focus on using LLMs to resolve code quality issues in multiple programming languages. Several recent studies~\cite{jin2023programrepair, yang2024programrepair, xia2024programrepair} address applying LLMs to program repair. Nam et al.~\cite{nam2024codeunderstand} apply the GPT model to explain code and provide usage details.
The existing approaches focus on different purposes compared to \toolchecker.
Zhang et al.~\cite{zhang2024codeinconsistency,zhang2024codeinconsistencyase} use LLMs to extract constraints from code comments, and apply AST-based program analysis to identify inconsistencies.
