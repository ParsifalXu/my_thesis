...
\fref{fig:ebnf} shows an EBNF grammar for our multi-parameter constraints.
...
As illustrated in \eref{eq:embedding}, we design an operator embedding across five key dimensions: \underline{\textbf{C}}omparison, \underline{\textbf{E}}quality, \underline{\textbf{G}}reater than, \underline{\textbf{L}}ess than, and \underline{\textbf{N}}egativity.
