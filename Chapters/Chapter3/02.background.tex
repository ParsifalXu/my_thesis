...
To ensure the representativeness and reproducibility of the \toolcompsuite dataset, the selection process focuses on high-quality and popular client projects and
...
research~\cite{mostafa2017study,wu2016exploratory,qiu2016understanding,kula2014visualizing}. A library is included in the dataset only if it has more than 100 usages (i.e., clients) on Maven
