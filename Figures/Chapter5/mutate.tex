% Adapted from paper-aone-improve icse27-dataloc b7f3453.
...
\matrix[
  ...
  $M_1$: $x \mapsto$ $y\land x \sqsubseteq y$ & \textcolor{blue}{0 $\rightarrow$ 9} \\
  $M_3$: drop 1 body atom &  0 $\rightarrow$ 0\\
  $\ldots$: \ldots &  \ldots \\
};
...
\draw[line]
  ...
  node[
    ...
    $\diamond$ mutations: $M_1$, $M_3$, \ldots; $\Delta$: 0$\rightarrow$9,\;0$\rightarrow$0, \ldots \\
